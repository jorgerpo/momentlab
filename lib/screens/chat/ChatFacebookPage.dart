...
import 'dart:async';
import 'dart:math';
import 'package:UIKit/utils/CustomChatTheme.dart';
...
class _ChatFacebookScreenState extends State<ChatFacebookScreen> {
  ...
  initState() {
    ...
    _chatList.add(ChatModel("Hii", ChatModel.myId, DateTime.now().millisecondsSinceEpoch.toString(), "sent"));
    _chatList.add(ChatModel("Hii", ChatModel.otherId, DateTime.now().millisecondsSinceEpoch.toString(), "sent"));
  }
      ...
      child: MaterialApp(
          ...
          home: Scaffold(
            appBar: AppBar(
              ...
              actions: <Widget>[
                Icon(MdiIcons.phone,color: customChatTheme.btnColor,),
                Container(margin: EdgeInsets.only(left: 16),
                    child: Icon(MdiIcons.video,color: customChatTheme.btnColor,)),
                PopupMenuButton(
                  onSelected: (choice) {
                      ...
                      Container(
                        ...
                        child: Center(
                          ...
                          style: themeData.textTheme.caption.merge(TextStyle(
                              color:
                                  customChatTheme.onBackground.withAlpha(180),
                              letterSpacing: 0.3,
      ...
      return Container(
          ...
          child: Text(
            ...
            style: themeData.textTheme.subtitle1
                .merge(TextStyle(color: customChatTheme.onMyChat)),
            ...
            Flexible(
              child: Container(
                  ...
                  child: Text(
                    _chatList[index].message,
                    style: themeData.textTheme.subtitle1
                        .merge(TextStyle(color: customChatTheme.onChat)),
                    overflow: TextOverflow.fade,
                  )),
            ),
          ],
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text("Are you sure to clear messages in this chat",
                  style: themeData.textTheme.subtitle1.merge(TextStyle(
                      color: customChatTheme.onBackground.withAlpha(200),
